...
#-------------------------------------------------------------------------------
AROOT := /home/lz/arduino-1.7.11-linux64/hardware/arduino/sam/system
vpath %.c $(PROJECT_DIR)
VPATH+=$(PROJECT_DIR)

INCLUDES =
INCLUDES += -I$(AROOT)/libsam
INCLUDES += -I$(AROOT)/CMSIS/Device/ATMEL
INCLUDES += -I$(AROOT)/CMSIS/CMSIS/Include
...
#  Toolchain
#-------------------------------------------------------------------------------
CROSS_COMPILE = /home/lz/arduino-1.7.11-linux64/hardware/tools/gcc-arm-none-eabi-4.8.3-2014q1/bin/arm-none-eabi-
AR = $(CROSS_COMPILE)ar
...
RM=rm -Rf
MKDIR=mkdir -p
UPLOAD_BOSSA=$(AROOT)/tools/bossac
...
LNK_SCRIPT=$(AROOT)/../variants/arduino_due_x/linker_scripts/gcc/flash.ld
LIBSAM_ARCHIVE=$(AROOT)/../variants/arduino_due_x/libsam_sam3x8e_gcc_rel.a
