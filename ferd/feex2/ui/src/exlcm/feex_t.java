...
public final class feex_t implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x3d069f0a4f96be5eL;
 
    static {
        LCM_FINGERPRINT = _hashRecursive(new ArrayList<Class<?>>());
//        System.out.println(""+Long.toHexString(LCM_FINGERPRINT));
    }
