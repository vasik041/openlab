...
#define	csport		PORTC
#define cspinmask	(1 << 5)

#define	rstport		PORTC
#define	rstpinmask	(1 << 4)

#define dcport          PORTC
#define dcpinmask	(1 << 3)

#define	mosiport	PORTB  		//SDI
#define	mosipinmask	(1 << 3)

#define	clkport         PORTB
#define	clkpinmask	(1 << 5)

//#define	misoport	PORTC		//SDO
//#define	misopinmask	(1 << 0)
